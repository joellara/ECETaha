...
public class KinectManager : MonoBehaviour
{
    ...
    public GameObject pinkbrick;
    public GameObject yellowbrick;
    public GameObject bluebrick;
    public GameObject success;
    private int selected= -1;
    private bool brick0Selected = false, brick1Selected = false, brick2Selected = false, correctAnswer = false;
						...
						if(gestureData.gesture == KinectGestures.Gestures.Click)
						{
                            ...
                            if (selected >= 0 && !correctAnswer)
                            {
                                ...
                                if((brick0Selected == true || brick1Selected == true || brick2Selected == true) && correctAnswer == true)
                                {
                                    ...
                                    success.GetComponent<TextMesh>().text = "YOU DID IT! \n You're awesome.";
                                    
                                }
                                if ((brick0Selected == true || brick1Selected == true || brick2Selected == true) && correctAnswer == false)
                                {
                                    success.SetActive(true);
                                    success.GetComponent<TextMesh>().text = "hmm, that kind be right? \n Try again.";
                                }
                            }
                        }
							...
							gestureData.progress >= 0.5f)
						{
							...
							if(GetGestureProgress(gestureData.userId, KinectGestures.Gestures.Click) < 0.3f)
							{
								...
								if(HandCursor1 != null && !correctAnswer)
								{
                                    ...
                                    else if (Math.Abs(1000 - hc_viewport.x - bluebrick_viewport.x) < 100 && brick0Selected == false)
                                    {
                                        bluebrick.transform.GetChild(0).GetComponent<Renderer>().material.SetColor("_Color", Color.grey);
                                        selected = 0;
                                    }
                                    else if (Math.Abs(hc_viewport.x - yellowbrick_viewport.x) < 100 && brick2Selected == false)
                                    {
                                        yellowbrick.transform.GetChild(0).GetComponent<Renderer>().material.SetColor("_Color", Color.grey);
                                        selected = 2;
                                    }
                                    else
                                    {
                                    ...
                                    if(selected != 1 && brick1Selected == false)
                                    {
                                        pinkbrick.transform.GetChild(0).GetComponent<Renderer>().material.SetColor("_Color", Color.blue);

                                    }
                                    if(selected != 2 && brick2Selected == false)
                                    {
                                        yellowbrick.transform.GetChild(0).GetComponent<Renderer>().material.SetColor("_Color", Color.yellow);
